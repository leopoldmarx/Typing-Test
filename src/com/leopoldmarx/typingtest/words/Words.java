package com.leopoldmarx.typingtest.words;
...
public class Words {
	...
	private ArrayList<String> top200words =  new ArrayList<>();
	
	public Words() {
		Collections.addAll(top200words, 
				"the", "be", "of", "and", "a",
				"to", "in", "he", "have", "it",
	...
	public String randomWord(){
		...
		return top200words.get((int)(200 * Math.random() - 1));
	}
}
